...
Use the native `sdd-research` sub-agent. If unavailable, read `.claude/skills/sdd-research/SKILL.md` from the project root and execute it inline without delegating.
