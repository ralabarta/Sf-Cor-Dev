...
- **openspec**: follow `.claude/skills/_shared/openspec-convention.md` from the project root when present, otherwise `~/.claude/skills/_shared/openspec-convention.md`; mark `[x]` in the file at the `tasks` locator.
