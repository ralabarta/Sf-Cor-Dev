...
- **hybrid**: Persist to both orchestrator-injected locators. Retrieve each dependency only through its injected locator(s); never prefer Engram, fall back to filesystem, or synthesize a locator.
