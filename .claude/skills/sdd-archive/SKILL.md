...
- **openspec**: Read and follow `.claude/skills/_shared/openspec-convention.md` from the project root when present, otherwise `~/.claude/skills/_shared/openspec-convention.md`. Perform merge and archive folder moves.
