...
artifactPaths:
  proposal: [<absolute repo path or Engram topic key>]
  specs: [<absolute repo paths or Engram topic keys>]
  design: [<absolute repo path or Engram topic key>]
  tasks: [<absolute repo path or Engram topic key>]
  applyProgress: [<absolute repo path or Engram topic key>]
  verifyReport: [<absolute repo path or Engram topic key>]
contextFiles:
  proposal: [<absolute readable repo path or Engram topic key>]
  specs: [<absolute readable repo paths or Engram topic keys>]
  design: [<absolute readable repo path or Engram topic key>]
  tasks: [<absolute readable repo path or Engram topic key>]
  applyProgress: [<absolute readable repo path or Engram topic key>]
  verifyReport: [<absolute readable repo path or Engram topic key>]
artifacts:
...
`artifactPaths` and `contextFiles` contain store-native locators: absolute repository paths for OpenSpec or Engram topic keys. Engram topic keys are locators, not filesystem paths. In `hybrid` mode, use the exact native locators for both stores; never synthesize or substitute a locator.
